...
export const ANALYSTS: AnalystSeed[] = [
  { handle: "marcus_webb", name: "Marcus Webb", headline: "Multi-cap generalist. 15 years on the buy side.", bio: "Former PM at a long-only fund. A few high-conviction calls per quarter, and the tape grades them.", specialty: "Generalist", tags: ["valuation", "earnings"], tickers: ["NVDA", "MSFT", "JPM", "AVGO"], minPubs: 30, maxPubs: 38, joinedDaysAgo: 640, sub: 49, report: 15, followers: 24_800, verified: true },
  { handle: "maren_vos", name: "Maren Vos", headline: "Semis and AI infrastructure. Concentrated, high conviction.", bio: "Covering the accelerator supply chain end to end. I size around catalysts, not narratives.", specialty: "Semiconductors", tags: ["semiconductors", "ai-buildout"], tickers: ["NVDA", "AVGO", "AMD", "MU", "TSM"], minPubs: 32, maxPubs: 40, joinedDaysAgo: 520, sub: 39, report: 12, followers: 19_200, verified: true },
  { handle: "fatima_alhariri", name: "Fatima Al-Hariri", headline: "Healthcare and biotech catalysts. Event driven.", bio: "PhD pharmacology. PDUFA dates, trial readouts, and mispriced optionality in mid-cap biotech.", specialty: "Healthcare", tags: ["healthcare", "obesity-drugs", "event-driven"], tickers: ["LLY", "NVO", "PFE", "TEVA.TA"], minPubs: 12, maxPubs: 16, joinedDaysAgo: 480, sub: 35, report: 12, followers: 11_400, verified: true },
  { handle: "dhruv_anand", name: "Dhruv Anand", headline: "Deep value in industrials and energy. Patient, contrarian.", bio: "Graham-Dodd mindset with a macro overlay. I wait for forced sellers.", specialty: "Value / Energy", tags: ["energy", "industrials", "valuation"], tickers: ["XOM", "CVX", "OXY", "CAT"], minPubs: 9, maxPubs: 14, joinedDaysAgo: 410, sub: 19, report: 7, followers: 6_900, verified: true },
  { handle: "yuki_tanaka", name: "Yuki Tanaka", headline: "Asia tech supply chain and ADRs.", bio: "Tokyo based. The bridge between US listings and Asia fundamentals.", specialty: "Asia Tech", tags: ["semiconductors", "china"], tickers: ["TSM", "MU", "ARM", "QCOM"], minPubs: 8, maxPubs: 13, joinedDaysAgo: 390, sub: 22, report: 8, followers: 7_300, verified: true },
  { handle: "theo_marchetti", name: "Theo Marchetti", headline: "Macro-aware single names. Risk first.", bio: "Rates, FX and positioning drive my single-stock work. Every call has an invalidation level.", specialty: "Macro / Single-stock", tags: ["rates", "fx"], tickers: ["JPM", "GS", "MSFT"], minPubs: 10, maxPubs: 15, joinedDaysAgo: 360, sub: 24, report: 8, followers: 5_100 },
  { handle: "james_okonkwo", name: "James Okonkwo", headline: "Energy transition and traditional oil and gas.", bio: "Upstream, LNG and grid bottlenecks. Earnings revisions are the edge.", specialty: "Energy", tags: ["energy", "energy-transition", "grid-capex"], tickers: ["XOM", "SLB", "OXY", "CVX"], minPubs: 7, maxPubs: 12, joinedDaysAgo: 340, sub: 18, report: 6, followers: 4_400 },
  { handle: "lena_kowal", name: "Lena Kowalczyk", headline: "Consumer and software. Earnings driven.", bio: "Short-horizon work around prints. Unit economics and churn, not slide decks.", specialty: "Consumer / SaaS", tags: ["software", "consumer", "earnings"], tickers: ["MSFT", "CRM", "SNOW", "SHOP"], minPubs: 8, maxPubs: 13, joinedDaysAgo: 320, sub: 15, report: 5, followers: 3_800 },
  { handle: "priya_raman", name: "Priya Raman", headline: "Fintech and payments. Unit economics obsessed.", bio: "Former product lead at a neobank. I stress-test take rates, CAC and regulatory risk.", specialty: "Fintech", tags: ["payments", "financials"], tickers: ["V", "MA", "COIN", "JPM"], minPubs: 6, maxPubs: 11, joinedDaysAgo: 300, sub: 20, report: 7, followers: 4_950 },
  { handle: "olivia_grant", name: "Olivia Grant", headline: "Dividend growers and quality compounders.", bio: "Low turnover, long horizons. Durable returns on capital and management that allocates well.", specialty: "Dividends", tags: ["valuation", "financials"], tickers: ["JPM", "XOM", "V", "CAT"], minPubs: 5, maxPubs: 9, joinedDaysAgo: 280, sub: 12, report: 4, followers: 2_600 },
  { handle: "sara_cohen", name: "Sara Cohen", headline: "TASE tech and growth, from Tel Aviv.", bio: "Israeli equities in English. NICE, the CyberArk ecosystem and dual-listed names.", specialty: "Israel / TASE", tags: ["israel", "software"], tickers: ["NICE.TA", "CHKP.TA", "WIX.TA", "MNDY.TA"], minPubs: 30, maxPubs: 36, joinedDaysAgo: 470, sub: 29, report: 9, followers: 9_800, verified: true },
  { handle: "elena_petrova", name: "Elena Petrova", headline: "Contrarian shorts. Often wrong, occasionally very right.", bio: "A high-beta book of tactical shorts. Volatile record, and I publish all of it.", specialty: "Contrarian / Short", tags: ["short-thesis", "technicals"], tickers: ["TSLA", "NVDA", "COIN", "PLTR"], minPubs: 30, maxPubs: 38, joinedDaysAgo: 500, sub: 11, report: 4, followers: 8_200 },
  { handle: "adam_rosen", name: "Adam Rosen", headline: "Israeli defense and industrials.", bio: "Covering Elbit, IAI suppliers and the European procurement cycle.", specialty: "Defense", tags: ["defense", "israel", "industrials"], tickers: ["ESLT.TA", "LMT", "ICL.TA"], minPubs: 10, maxPubs: 15, joinedDaysAgo: 350, sub: 27, report: 9, followers: 6_100, verified: true },
  { handle: "nadia_haddad", name: "Nadia Haddad", headline: "Memory and storage cycles.", bio: "DRAM, NAND and HBM. The cycle is the thesis; timing it is the job.", specialty: "Memory", tags: ["memory", "semiconductors"], tickers: ["MU", "TSEM.TA", "NVDA"], minPubs: 7, maxPubs: 12, joinedDaysAgo: 290, sub: 21, report: 7, followers: 3_450 },
  { handle: "gabriel_stern", name: "Gabriel Stern", headline: "Banks and credit, US and Israel.", bio: "Deposit betas, reserve builds and the parts of a bank that break first.", specialty: "Financials", tags: ["financials", "credit", "rates"], tickers: ["JPM", "GS", "BAC", "POLI.TA", "LUMI.TA"], minPubs: 9, maxPubs: 14, joinedDaysAgo: 310, sub: 23, report: 8, followers: 4_700 },
  { handle: "hana_ito", name: "Hana Ito", headline: "Autos and the electrification supply chain.", bio: "From cells to charging. I model unit economics per vehicle, not per narrative.", specialty: "Autos", tags: ["autos", "energy-transition"], tickers: ["TSLA", "AMD"], minPubs: 6, maxPubs: 11, joinedDaysAgo: 260, sub: 14, report: 5, followers: 2_900 },
  { handle: "ruth_bergman", name: "Ruth Bergman", headline: "Israeli banks and the macro that moves them.", bio: "Tel Aviv based. Rates, shekel and the domestic credit cycle.", specialty: "Israel / Macro", tags: ["israel", "financials", "rates"], tickers: ["POLI.TA", "LUMI.TA", "ICL.TA"], minPubs: 8, maxPubs: 13, joinedDaysAgo: 300, sub: 18, report: 6, followers: 3_200 },
  { handle: "daniel_okafor", name: "Daniel Okafor", headline: "Enterprise software, seat counts first.", bio: "I care about net revenue retention and almost nothing else.", specialty: "Software", tags: ["software", "earnings"], tickers: ["CRM", "SNOW", "MSFT", "MNDY.TA"], minPubs: 7, maxPubs: 12, joinedDaysAgo: 270, sub: 17, report: 6, followers: 3_050 },
  { handle: "mira_solberg", name: "Mira Solberg", headline: "Nordic industrials and grid capex.", bio: "Electrification hardware, transformers and the interconnect bottleneck.", specialty: "Industrials", tags: ["grid-capex", "industrials"], tickers: ["CAT", "DE", "SLB"], minPubs: 6, maxPubs: 11, joinedDaysAgo: 250, sub: 16, report: 6, followers: 2_400 },
  { handle: "omar_farouk", name: "Omar Farouk", headline: "Oil macro and the majors.", bio: "Barrels, spreads and the capital discipline cycle.", specialty: "Oil", tags: ["oil-energy", "energy"], tickers: ["XOM", "CVX", "OXY"], minPubs: 7, maxPubs: 12, joinedDaysAgo: 240, sub: 15, report: 5, followers: 2_150 },
  { handle: "claire_dubois", name: "Claire Dubois", headline: "Luxury, consumer and the European tape.", bio: "Pricing power is the only moat I trust in consumer.", specialty: "Consumer", tags: ["consumer", "valuation"], tickers: ["V", "MA", "NFLX"], minPubs: 5, maxPubs: 10, joinedDaysAgo: 230, sub: 13, report: 5, followers: 1_900 },
  { handle: "tomer_avraham", name: "Tomer Avraham", headline: "Israeli small and mid caps.", bio: "The names no sell-side analyst covers. High variance, deep work.", specialty: "Israel / Small-cap", tags: ["israel", "valuation"], tickers: ["TSEM.TA", "ICL.TA", "WIX.TA"], minPubs: 8, maxPubs: 13, joinedDaysAgo: 220, sub: 12, report: 4, followers: 1_650 },
  { handle: "victor_reyes", name: "Victor Reyes", headline: "Event driven. Mergers, spins and forced sellers.", bio: "I trade the calendar, not the story.", specialty: "Event-driven", tags: ["event-driven", "valuation"], tickers: ["BA", "OXY", "PFE"], minPubs: 9, maxPubs: 14, joinedDaysAgo: 330, sub: 25, report: 9, followers: 4_100, verified: true },
  { handle: "anya_volkov", name: "Anya Volkov", headline: "Technicals and positioning.", bio: "Flows, gamma and where the marginal buyer has to come from.", specialty: "Technicals", tags: ["technicals", "rates"], tickers: ["NVDA", "TSLA", "MSFT"], minPubs: 10, maxPubs: 15, joinedDaysAgo: 210, sub: 10, report: 4, followers: 2_750 },
  { handle: "ben_shapiro_il", name: "Ben Shapira", headline: "Cyber and Israeli security software.", bio: "Check Point, CyberArk and the private pipeline behind them.", specialty: "Cyber", tags: ["israel", "software"], tickers: ["CHKP.TA", "NICE.TA"], minPubs: 7, maxPubs: 12, joinedDaysAgo: 280, sub: 26, report: 8, followers: 5_300, verified: true },
  { handle: "sofia_lindqvist", name: "Sofia Lindqvist", headline: "Healthcare services and payers.", bio: "The unglamorous half of healthcare, where the cash actually is.", specialty: "Healthcare", tags: ["healthcare", "valuation"], tickers: ["PFE", "LLY", "TEVA.TA"], minPubs: 6, maxPubs: 11, joinedDaysAgo: 200, sub: 16, report: 6, followers: 1_800 },
  { handle: "kwame_boateng", name: "Kwame Boateng", headline: "Materials, mining and the input cost cycle.", bio: "Copper, lithium and the things every other thesis depends on.", specialty: "Materials", tags: ["materials", "inflation"], tickers: ["ICL.TA", "CAT", "SLB"], minPubs: 5, maxPubs: 10, joinedDaysAgo: 190, sub: 14, report: 5, followers: 1_500 },
  { handle: "elior_shani", name: "Elior Shani", headline: "Israeli tech, private to public.", bio: "IPO pipeline, secondaries and the dual-listing arbitrage.", specialty: "Israel / IPO", tags: ["israel", "ipo"], tickers: ["MNDY.TA", "WIX.TA", "NICE.TA"], minPubs: 6, maxPubs: 11, joinedDaysAgo: 180, sub: 19, report: 7, followers: 2_050 },
  { handle: "grace_holloway", name: "Grace Holloway", headline: "Media, streaming and the content cost curve.", bio: "Subscriber economics after the growth-at-any-cost era.", specialty: "Media", tags: ["media", "consumer"], tickers: ["NFLX", "META", "GOOGL"], minPubs: 5, maxPubs: 10, joinedDaysAgo: 175, sub: 13, report: 5, followers: 1_720 },
  { handle: "raphael_moreau", name: "Raphael Moreau", headline: "Aerospace and space infrastructure.", bio: "Launch economics, satellite capex and the defense adjacency.", specialty: "Space", tags: ["space", "defense"], tickers: ["BA", "LMT", "ESLT.TA"], minPubs: 6, maxPubs: 11, joinedDaysAgo: 170, sub: 17, report: 6, followers: 1_640 },
  { handle: "iris_nakamura", name: "Iris Nakamura", headline: "Hardware and the consumer device cycle.", bio: "Bill of materials, replacement cycles and channel inventory.", specialty: "Hardware", tags: ["hardware", "consumer"], tickers: ["AAPL", "QCOM", "ARM"], minPubs: 5, maxPubs: 10, joinedDaysAgo: 165, sub: 12, report: 4, followers: 1_380 },
  { handle: "noah_feldman", name: "Noah Feldman", headline: "Small-cap discovery. High variance by design.", bio: "Many ideas, smaller size. The record is still forming, so judge the process.", specialty: "Small-cap", tags: ["valuation", "technicals"], tickers: ["PLTR", "COIN", "SNOW"], minPubs: 8, maxPubs: 13, joinedDaysAgo: 160, sub: 9, report: 3, followers: 1_250 },
  { handle: "leah_mizrahi", name: "Leah Mizrahi", headline: "Israeli consumer and retail.", bio: "The domestic economy from the shelf up.", specialty: "Israel / Consumer", tags: ["israel", "consumer"], tickers: ["ICL.TA", "POLI.TA"], minPubs: 5, maxPubs: 9, joinedDaysAgo: 150, sub: 11, report: 4, followers: 1_100 },
  { handle: "arjun_mehta", name: "Arjun Mehta", headline: "Cloud infrastructure and the capex cycle.", bio: "Where the hyperscaler dollar actually lands.", specialty: "Cloud", tags: ["ai-buildout", "software"], tickers: ["MSFT", "AMZN", "GOOGL", "AVGO"], minPubs: 7, maxPubs: 12, joinedDaysAgo: 145, sub: 20, report: 7, followers: 2_300 },
  { handle: "freya_andersen", name: "Freya Andersen", headline: "Rates, FX and the macro overlay.", bio: "I publish the macro that the single-name people should be reading.", specialty: "Macro", tags: ["rates", "fx", "inflation"], tickers: ["JPM", "GS"], minPubs: 6, maxPubs: 11, joinedDaysAgo: 140, sub: 18, report: 6, followers: 1_900 },
  { handle: "carlos_mendez", name: "Carlos Mendez", headline: "Just getting started on Stoa.", bio: "Publishing my first calls in public. Former equity sales, learning to put skin in the game.", specialty: "Learning", tags: ["valuation"], tickers: ["AAPL", "MSFT"], minPubs: 1, maxPubs: 2, joinedDaysAgo: 9, sub: 0, report: 0, followers: 62 },
  { handle: "tal_benari", name: "Tal Ben-Ari", headline: "New here. Israeli tech, mostly semis.", bio: "First publications going up now. Ten years in the industry, none of it in public.", specialty: "Israel / Semis", tags: ["israel", "semiconductors"], tickers: ["TSEM.TA", "NVDA"], minPubs: 1, maxPubs: 2, joinedDaysAgo: 6, sub: 0, report: 0, followers: 41 },
  { handle: "wei_zhang", name: "Wei Zhang", headline: "Recently joined. China tech and the export-control cycle.", bio: "Starting to publish the work I have been writing privately for years.", specialty: "China Tech", tags: ["china", "semiconductors"], tickers: ["TSM", "QCOM"], minPubs: 1, maxPubs: 2, joinedDaysAgo: 4, sub: 0, report: 0, followers: 28 },
  { handle: "hannah_pruitt", name: "Hannah Pruitt", headline: "New. Energy and utilities.", bio: "Grid economics, from a decade inside a utility planning desk.", specialty: "Utilities", tags: ["grid-capex", "energy"], tickers: ["XOM", "CAT"], minPubs: 1, maxPubs: 2, joinedDaysAgo: 2, sub: 0, report: 0, followers: 13 },
  { handle: "isaac_levy", name: "Isaac Levy", headline: "Quant-ish. Factor exposures behind single names.", bio: "I decompose every thesis into the factors that will actually drive it.", specialty: "Quant", tags: ["technicals", "valuation"], tickers: ["NVDA", "MSFT", "JPM", "TSLA"], minPubs: 9, maxPubs: 14, joinedDaysAgo: 135, sub: 22, report: 8, followers: 2_600 },
];
