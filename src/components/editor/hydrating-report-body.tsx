...
/* ssr:false keeps the whole Tiptap runtime (editor core, node views,
 * lightweight-charts, KaTeX) out of the route's First Load JS. The reader
 * gets the server-rendered static body instantly; this chunk streams in
 * behind it and swaps over once its editor instance exists. */
