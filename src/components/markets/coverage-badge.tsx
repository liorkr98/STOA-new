...
export function StoaCoverageBadge({ count }: { count: number }) {
  return (
    <span className="inline-flex items-center gap-1.5 rounded-[var(--radius-tag)] border border-border bg-surface-2 px-2.5 py-1 text-xs font-medium text-text-mute">
