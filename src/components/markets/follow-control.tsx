...
const pill =
  "num tap-target focus-ring inline-flex shrink-0 items-center rounded-[var(--radius-tag)] border px-2.5 py-1 text-[0.6875rem] font-semibold uppercase tracking-[0.12em] transition-colors duration-[var(--dur-1)]";
