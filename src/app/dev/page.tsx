...
const ROUTES: { href: string; label: string; note: string }[] = [
  ...
  { href: "/dev/today?lead=processing", label: "Today · clip processing", note: "The lead publication's clip is on the way; the frame stays instead of the row going written." },
  { href: "/dev/video-states", label: "Video states", note: "The report page's processing and failed frames, and the small processing thumb, at the sizes they ship." },
  { href: "/dev/studio", label: "Publications", note: "A creator's list with a draft, a piece with a stance, a note with none and an archived piece; hover a row for its actions." },
  { href: "/dev/compose", label: "Compose · type picker", note: "The first screen: three types by purpose and four drafts along their spines." },
  { href: "/dev/compose?shape=stance", label: "Compose · stance", note: "A thesis draft carrying NVDA long: open Stance from the publish screen's features menu." },
  { href: "/dev/compose?shape=thesis", label: "Compose · thesis", note: "A thesis at its tags step with the type-to-narrow tag list, then the publish screen's features menu with cards added and a stance to add." },
  { href: "/dev/compose?shape=brief", label: "Compose · brief", note: "A brief at its headline step, with where the line travels." },
  { href: "/dev/compose?shape=video", label: "Compose · video", note: "A new video from its first step: the rung, then the spine." },
  ...
  { href: "/dev/components", label: "Components", note: "Shared primitives: chips, buttons, cards." },
  { href: "/dev/marks", label: "Marks", note: "Wordmark and brand marks." },
  { href: "/dev/chart-read", label: "Chart read", note: "The price chart against sample candles." },
];
