...
export async function generateMetadata({
  ...
  return { title: profile ? `${profile.display_name} · MOAT Analytics` : "MOAT Analytics" };
}

/** Lightweight in-memory percentile -- fine at this scale, revisit with a
 * SQL rank query if the analyst pool grows large enough to matter. */
...
export default async function MoatAnalyticsPage({
  params,
}: {
  params: Promise<{ handle: string }>;
}) {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8">
      <div>
        ...
        <h1 className="t-h1 mt-2">MOAT Analytics</h1>
      ...
      <Link href="/scoring#moat-score" className="t-meta underline hover:no-underline">
