...
const SPECS: Spec[] = [
  {
    ...
    }, by: LENA, type: "VERDICT", headline: "Blackwell demand is still under-modelled into the January quarter", deck: "Hyperscaler capex guides imply a supply-constrained first half.", ticker: "NVDA", dir: "long", sector: "Semiconductors", secs: 222, hours: 2, views: 4820, locked: [false, false, true, true, true, true, true, true], access: "subscribers" },
  { id: "x2", by: KAI, type: "VERDICT", headline: "The refiners nobody is modelling correctly", deck: "Crack spreads held through a quarter that should have crushed them.", ticker: "VLO", dir: "long", sector: "Energy", secs: 187, hours: 4, views: 3100 },
  ...
  { id: "x4", by: MARCUS, type: "VERDICT", headline: "Shorting the last honest regional bank", ticker: "ZION", dir: "short", sector: "Financials", secs: 240, hours: 7, views: 1900, locked: [false, true, true, true, true, true, true, true], access: "paid" },
  { id: "x5", by: NOOR, type: "VERDICT", headline: "Copper is the only clean energy trade left", ticker: "FCX", dir: "long", sector: "Materials", secs: 140, hours: 6, views: 2600 },
  { id: "x6", by: DANA, type: "VERDICT", headline: "Micron: HBM pricing holds through the cycle", ticker: "MU", dir: "long", sector: "Semiconductors", secs: 187, hours: 9, views: 5610, seal: { status: "hit", dateISO: hoursAgo(30) } },
  ...
  { id: "x9", by: PRIYA, type: "VERDICT", headline: "Semis are not one trade anymore", ticker: "SMH", dir: "long", sector: "Semiconductors", secs: 200, hours: 14, views: 3300 },
  { id: "x10", by: LENA, type: "VERDICT", headline: "AMD's MI350 window is narrower than the bulls think", ticker: "AMD", dir: "short", sector: "Semiconductors", secs: 301, hours: 20, views: 3910, seal: { status: "near", dateISO: hoursAgo(50) } },
  ...
  { id: "x13", by: OMAR, type: "VERDICT", headline: "Valero into the turnaround season", ticker: "VLO", dir: "long", sector: "Energy", secs: 150, hours: 30, views: 900 },
  { id: "x14", by: IRIS, type: "VERDICT", headline: "Zions: the deposit beta problem", ticker: "ZION", dir: "short", sector: "Financials", secs: 130, hours: 33, views: 700 },
  { id: "x15", by: PRIYA, type: "THESIS", headline: "ASML after the bookings trough", ticker: "ASML", dir: "long", sector: "Semiconductors", secs: 280, hours: 40, views: 2980, seal: { status: "miss", dateISO: hoursAgo(80) } },
  { id: "x16", by: LENA, type: "VERDICT", headline: "TSMC's N2 ramp is the capex the market is not pricing", ticker: "TSM", dir: "long", sector: "Semiconductors", secs: 240, hours: 44, views: 1330 },
  { id: "x17", by: OMAR, type: "VERDICT", headline: "Exxon: supply discipline holds through the summer", ticker: "XOM", dir: "long", sector: "Energy", secs: 175, hours: 50, views: 1100 },
  ...
  { id: "x19", by: KAI, type: "VERDICT", headline: "Cheniere and the LNG contract cliff", ticker: "LNG", dir: "long", sector: "Energy", secs: 210, hours: 60, views: 640 },
  { id: "x20", by: MARCUS, type: "VERDICT", headline: "Regional banks: the next shoe", ticker: "KRE", dir: "short", sector: "Financials", secs: 95, hours: 66, views: 1500 },
  { id: "x21", by: NOOR, type: "VERDICT", headline: "Freeport at the top of the copper curve", ticker: "FCX", dir: "long", sector: "Materials", secs: 130, hours: 70, views: 1250 },
  { id: "x22", by: DANA, type: "VERDICT", headline: "Lam Research: the etch intensity story", ticker: "LRCX", dir: "long", sector: "Semiconductors", secs: 190, hours: 80, views: 700 },
  ...
  { id: "x24", by: IRIS, type: "VERDICT", headline: "Arm's royalty mix is where the models break", ticker: "ARM", dir: "long", sector: "Semiconductors", secs: 180, hours: 100, views: 2200 },
  { id: "x25", by: PRIYA, type: "BRIEF", headline: "Three charts on the dollar", theme: "MACRO · FX", secs: 75, hours: 110, views: 420 },
  { id: "x26", by: LENA, type: "VERDICT", headline: "Broadcom's custom silicon runway", ticker: "AVGO", dir: "long", sector: "Semiconductors", secs: 200, hours: 120, views: 1800 },
  { id: "x27", by: KAI, type: "VERDICT", headline: "Chevron's Permian math", ticker: "CVX", dir: "long", sector: "Energy", secs: 160, hours: 130, views: 900 },
  { id: "x28", by: MARCUS, type: "VERDICT", headline: "Chubb: pricing power in a hard market", ticker: "CB", dir: "long", sector: "Financials", secs: 140, hours: 140, views: 780 },
  { id: "x29", by: NOOR, type: "VERDICT", headline: "Eaton: the transformer shortage is a decade long", ticker: "ETN", dir: "long", sector: "Industrials", secs: 210, hours: 150, views: 1650 },
  { id: "x30", by: DANA, type: "VERDICT", headline: "Applied Materials into the ramp", ticker: "AMAT", dir: "long", sector: "Semiconductors", secs: 170, hours: 160, views: 620 },
];
