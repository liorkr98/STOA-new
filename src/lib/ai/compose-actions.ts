...
- insert_paragraph — plain prose (text required)
...
- insert_diagram — built-in AI diagram from text (text = prompt; uses OpenNapkin-style templates)
- visualize_selection — chart/diagram from highlighted text (visualizeMode: chart|diagram|both; needs selection in context)
...
- replace_selection — rewrite highlighted text (text required; needs selection in context)
Use ticker from context when omitted. Prefer insert_diagram for "visualize this paragraph" without a live chart. Use visualize_selection when context includes a selection with ticker/levels.`;
