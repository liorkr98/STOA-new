...
export const ALERT_DEFINITIONS: AlertDefinition[] = [
  ...
  },
  {
    ...
    description: "Analyst publishes a video, a thesis or a brief",
    channel: "marketing",
    defaultDelivery: "digest",
  },
  {
    ...
    description: "Scheduled job error (metrics, subscription expiry, etc.)",
    channel: "bugs",
    defaultDelivery: "immediate",
  },
  {
    ...
    description: "Scheduled job OK ping",
    channel: "ops",
    defaultDelivery: "immediate",
  },
  {
